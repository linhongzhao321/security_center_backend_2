...
func (g *Checkin) Checkin(c GoogleDevice) error {
	var m protobuf.Message
	m.Add(4, func(m *protobuf.Message) {
		m.Add(1, func(m *protobuf.Message) {
			m.AddVarint(10, androidApi)
		})
	})
	m.AddVarint(14, 3)
...
func (g *Checkin) Unmarshal() error {
	return g.m.Consume(g.Data)
}

// x-dfe-device-id
func (g Checkin) deviceId() (uint64, error) {
