...
func (g Checkin) Delivery(ctx context.Context, auth GoogleAuth, bundleID string, version uint64, single bool) (*Delivery, error) {
	req, err := http.NewRequestWithContext(ctx, "GET", "https://android.clients.google.com", nil)
	if err != nil {
		return nil, err
	}
	...
	req.URL.RawQuery = url.Values{
		"doc": {bundleID},
		"vc":  {strconv.FormatUint(version, 10)},
	}.Encode()
	auth.authorization(req)
	userAgent(req, single)
